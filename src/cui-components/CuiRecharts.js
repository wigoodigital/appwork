...
class CuiRecharts extends Component {
  render() {
    const isIE10Mode = document['documentMode'] === 10
    const isDarkStyle = themeSettings.isDarkStyle()

    const axisColor = isDarkStyle ? '#383b40' : '#ddd'
    const gridColor = isDarkStyle ? '#383b40' : '#ddd'
    const labelColor = isDarkStyle ? '#fff' : '#4E5155'

    return (
      <div className="ui-block">
        <h3 className="ui-block-heading">recharts</h3>
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/recharts/recharts" className="ui-block-description">https://github.com/recharts/recharts</a>

        <div className="no-ie10" data-name="recharts"></div>
          ...
          <div className="cui-example cui-example-vertical-spacing">
            ...
            <div style={{ width: '100%', height: 300 }}>
              <Recharts.ResponsiveContainer>
                ...
                >
                  ...
                  <Recharts.XAxis dataKey="name" axisLine={{ stroke: axisColor }} tick={{ fill: labelColor }} />
                  <Recharts.YAxis axisLine={{ stroke: axisColor }} tick={{ fill: labelColor }} />
                  <Recharts.Tooltip />
                  <Recharts.Legend />
            ...
            <div style={{ width: '100%', height: 300 }}>
              <Recharts.ResponsiveContainer>
                ...
                >
                  <Recharts.CartesianGrid stroke={gridColor} />
                  <Recharts.XAxis dataKey="name" axisLine={{ stroke: axisColor }} tick={{ fill: labelColor }} />
                  <Recharts.YAxis axisLine={{ stroke: axisColor }} tick={{ fill: labelColor }} />
                  <Recharts.Tooltip />
                  <Recharts.Legend />
            ...
            <div style={{ width: '100%', height: 300 }}>
              <Recharts.ResponsiveContainer>
                ...
                >
                  <Recharts.CartesianGrid stroke={gridColor} />
                  <Recharts.XAxis type="number" dataKey="x" name="stature" unit="cm" axisLine={{ stroke: axisColor }} tick={{ fill: labelColor }} />
                  <Recharts.YAxis type="number" dataKey="y" name="weight" unit="kg" axisLine={{ stroke: axisColor }} tick={{ fill: labelColor }} />
            ...
            <div style={{ width: '100%', height: 500 }}>
              <Recharts.ResponsiveContainer>
                <Recharts.RadarChart cx={300} cy={250} outerRadius={150} width={500} height={500} data={radarData}>
                  ...
                  <Recharts.PolarAngleAxis dataKey="subject" tick={{ fill: labelColor }} stroke={gridColor} />
            ...
            <div style={{ width: '100%', height: 500 }}>
              <Recharts.ResponsiveContainer>
                <Recharts.RadialBarChart width={500} height={300} cx={150} cy={150} innerRadius={20} outerRadius={140} barSize={10} data={radialData}>
                  <Recharts.RadialBar minAngle={15} label={{ position: 'insideStart', fill: '#fff' }} background={{ fill: gridColor }} clockWise dataKey="uv" />
