  ...
  render() {
    return (
      <div className="ui-block">
        ...
        <h4 className="ui-block-heading">Brand image</h4>

        <div className="cui-example">
          <div className="mb-4">
            <Button variant="primary" onClick={() => this.setState({
              sidenavImgCollapsed: !this.state.sidenavImgCollapsed
            })}>Toggle collapsed</Button>
          </div>

          <Sidenav className={`d-inline-flex bg-light align-top mr-4 mb-4 ${this.state.sidenavImgCollapsed ? 'sidenav-collapsed' : ''}`} style={{height: '400px'}}>
            {/* Brand */}
            <div className="app-brand py-3">
              <a href="#d" onClick={this.prevent} className="d-block w-100">
                <img src={`${process.env.PUBLIC_URL}/img/app-brand-image.png`} alt="Brand" className="app-brand-img" />
                <img src={`${process.env.PUBLIC_URL}/img/app-brand-image-small.png`} alt="Brand" className="app-brand-img-collapsed mx-auto" />
              </a>
              <a href="#d" onClick={this.prevent} className="layout-sidenav-toggle sidenav-link text-large ml-auto">
                <i className="ion ion-md-menu align-middle"></i>
              </a>
