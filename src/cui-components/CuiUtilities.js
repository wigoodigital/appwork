      ...
      <div className="ui-block">
        ...
        <div className="cui-example cui-example-vertical-spacing">
          <div className="cui-utils-example-bg-color">
            ...
            <div className="row mx-0">
              <a href="#d" onClick={this.prevent} className="text-dark d-block col-sm bg-white"><code>.bg-white</code></a>
            </div>
            <div className="row mx-0">
        ...
        <div className="cui-example cui-example-vertical-spacing-sm">
          <div className="theme-bg-dark opacity-25 p-3"><code className="bg-transparent theme-text-white">.opacity-25</code></div>
          <div className="theme-bg-dark opacity-50 p-3"><code className="bg-transparent theme-text-white">.opacity-50</code></div>
          <div className="theme-bg-dark opacity-75 p-3"><code className="bg-transparent theme-text-white">.opacity-75</code></div>
          <div className="theme-bg-dark opacity-100 p-3"><code className="bg-transparent theme-text-white">.opacity-100</code></div>
        </div>
        ...
        <h4 className="ui-block-heading">Style-dependent classes</h4>
        ...
        <div className="cui-example">
          {/* theme-text-white */}
          <p className="theme-text-white"><code>.theme-text-white</code> - White (light or material style) / dark (dark style) text.</p>

          {/* theme-text-dark */}
          <p className="theme-text-dark"><code>.theme-text-dark</code> - Dark (light or material style) / white (dark style) text.</p>

          {/* theme-bg-white */}
          <p className="theme-bg-white theme-text-dark p-4"><code>.theme-bg-white</code> - White (light or material style) / dark (dark style) background.</p>

          {/* theme-bg-dark */}
          <p className="theme-bg-dark theme-text-white p-4"><code>.theme-bg-dark</code> - Dark (light or material style) / white (dark style) background.</p>

          {/* theme-border-white */}
          <p className="theme-border-white p-4" style={{ border: '1px solid' }}><code>.theme-border-white</code> - White (light or material style) / dark (dark style) border.</p>

          {/* theme-border-dark */}
          <p className="theme-border-dark p-4" style={{ border: '1px solid' }}><code>.theme-border-dark</code> - Dark (light or material style) / white (dark style) border.</p>
        </div>
      </div>
    )
  }
